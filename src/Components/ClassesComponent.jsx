    ...
    return (
        <div className='w-full h-auto flex flex-wrap justify-center mt-5 gap-5'>
            <div className='w-[80%] h-auto flex flex-col gap-2 sm:w-[40%] md:w-[30%]'>
                ...
                <p><NavLink to='/classes/pilates' className='text-xs font-mono text-blue-700 active:text-blue-900 active:underline active:underline-offset-4 md:hover:text-blue-900 md:hover:underline md:hover:underline-offset-4 lg:text-sm cursor-pointer'>Read More</NavLink></p>
            </div>
            <div className='w-[80%] h-auto flex flex-col gap-2 sm:w-[40%] md:w-[30%]'>
                ...
                <p><NavLink to='/classes/aerobicTraining' className='text-xs font-mono text-blue-700 active:text-blue-900 active:underline active:underline-offset-4 md:hover:text-blue-900 md:hover:underline md:hover:underline-offset-4 lg:text-sm cursor-pointer'>Read More</NavLink></p>
            </div>
            <div className='w-[80%] h-auto flex flex-col gap-2 sm:w-[40%] md:w-[30%]'>
                ...
                <p><NavLink to='/classes/crossFitworkout' className='text-xs font-mono text-blue-700 active:text-blue-900 active:underline active:underline-offset-4 md:hover:text-blue-900 md:hover:underline md:hover:underline-offset-4 lg:text-sm cursor-pointer'>Read More</NavLink></p>
            </div>
        </div>
    )
}
